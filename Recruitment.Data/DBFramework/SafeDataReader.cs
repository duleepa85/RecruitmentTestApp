...
namespace Recruitment.Data.DBFramework
{
    ...
    internal class SafeDataReader : IDataReader
    {
        ...
        {
            return GetDateTimeNull(GetOrdinal(name));
        }
        ...
        public int GetInt32(string i)
        {
            if (_dataReader.IsDBNull(GetOrdinal(i)))
            {
                return 0;
            }
            else
            {
                return _dataReader.GetInt32(GetOrdinal(i));
            }
        }
        ...
        public string GetString(string i)
        {
            ...
            {
                return _dataReader.GetString(GetOrdinal(i));
            }
        }
